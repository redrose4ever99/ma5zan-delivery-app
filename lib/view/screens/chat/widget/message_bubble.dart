...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String image = Get.find<ChatController>().userTypeIndex == 0
        ? message.sellerInfo != null
            ? message.sellerInfo.shops[0].image ?? ''
            : ''
        : Get.find<ChatController>().userTypeIndex == 0
            ? message.customer.image ?? ''
            : '';

    String name = Get.find<ChatController>().userTypeIndex == 0
        ? message.sellerInfo != null
            ? message.sellerInfo.shops[0].name
            : 'Shop not found'
        : Get.find<ChatController>().userTypeIndex == 0
            ? message.customer.fName + ' ' + message.customer.lName
    ...
    return (message != null && _isReply)
            ...
            child:
              ...
              Text(name,
                  style: rubikRegular.copyWith(
                      ...
                      color: Get.find<ChatController>().userTypeIndex == 0 &&
                              message.sellerInfo == null
        ...
        : Container(
            ...
            child:
              ...
              Text(
                  Get.find<ProfileController>().profileModel.fName +
                      " " +
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: CustomImage(
                        ...
                        height: 40,
                        image:
                            '${Get.find<SplashController>().baseUrls.deliverymanImageUrl}/${Get.find<ProfileController>().profileModel.image}',
                      ),
                    ),
                  ]),
              SizedBox(height: Dimensions.paddingSizeSmall),
