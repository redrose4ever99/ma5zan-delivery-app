...
class EarningStatementCard extends StatelessWidget {
  ...
  const EarningStatementCard({Key key, this.ordersWiseEarned})
      : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Row(children: [
                  Padding(
                      ...
                      child:
                          SizedBox(width: 20, child: Image.asset(Images.cash))),
                  Text(
                    '${'cash'.tr}',
                    style: rubikMedium.copyWith(
            ...
            Padding(
              padding:
                  EdgeInsets.symmetric(vertical: Dimensions.fontSizeExtraSmall),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Row(
                    children: [
                      SizedBox(
                          width: 20, child: Image.asset(Images.calenderIcon)),
                      Padding(
